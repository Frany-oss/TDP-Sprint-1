...
# Inicializacion de la clase de dibujo mediapipe, util para la anotacion.
mp_drawing = mp.solutions.drawing_utils

def detectPose(image, pose, verbose = False, display = True):
    '''
    Esta funcion realiza la deteccion de la postura en una imagen.
    Args:
        Imagen: La imagen de entrada con una persona destacada cuyos puntos de referencia de pose necesitan ser detectados.
        pose: La funcion de configuracion de la pose necesaria para realizar la deteccion de la misma.
        display: Un valor booleano que si se establece en true la funcion muestra la imagen resultante
                 y los puntos de referencia de la pose en un grafico 3D y no devuelve nada.
    ...
    if results.pose_landmarks:
        ...
        for landmark in results.pose_landmarks.landmark:
            ...
            # Anadimos los puntos de referencia a la lista
    ...
    # Comprueba si la imagen de entrada y la imagen resultante estan especificadas para ser mostradas.
    if display:
        ...
        # Tambien traza los puntos de referencia de la Pose en 3D.
